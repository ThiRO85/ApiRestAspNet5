...
namespace ApiRestAspNet5_01.Authentication.Implementations
{
    public class TokenService : ITokenService
    {
        private TokenCofiguration _configuration;

        public TokenService(TokenCofiguration configuration)
        {
        ...
        public ClaimsPrincipal GetPrincipalFromExpiratedToken(string token)
        {
